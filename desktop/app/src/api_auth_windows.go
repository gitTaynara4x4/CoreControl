...
func (a *App) refreshLocal(full bool) {
	...
	// A página Atividade usa a lista completa coletada por refreshActivity.
	// Não sobrescreve com a lista reduzida de collectProcesses, evitando pisca.
	if page != 4 && (full || len(procs) == 0) {
