...
CREATE TABLE IF NOT EXISTS companies (
    ...
    mesh_group_synced_at    TIMESTAMPTZ NULL,
    created_at              TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP
);

CREATE INDEX IF NOT EXISTS ix_companies_slug ON companies (slug);

ALTER TABLE companies ADD COLUMN IF NOT EXISTS mesh_group_id VARCHAR(190) NULL;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS mesh_group_name VARCHAR(190) NULL;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS mesh_group_synced_at TIMESTAMPTZ NULL;
...
ALTER TABLE enrollment_tokens ADD COLUMN IF NOT EXISTS purpose VARCHAR(24) NOT NULL DEFAULT 'computer';
...
CREATE TABLE IF NOT EXISTS devices (
    ...
    remote_last_seen    TIMESTAMPTZ NULL,
...
ALTER TABLE devices ADD COLUMN IF NOT EXISTS device_kind VARCHAR(24) NOT NULL DEFAULT 'computer';
CREATE INDEX IF NOT EXISTS ix_devices_device_kind ON devices (device_kind);
ALTER TABLE devices ADD COLUMN IF NOT EXISTS mesh_node_id VARCHAR(190) NULL;
ALTER TABLE devices ADD COLUMN IF NOT EXISTS remote_online BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE devices ADD COLUMN IF NOT EXISTS remote_checked_at TIMESTAMPTZ NULL;
ALTER TABLE devices ADD COLUMN IF NOT EXISTS remote_last_seen TIMESTAMPTZ NULL;
