...
def test_cache_busting_points_to_v1045():
    ...
    assert '/static/styles.css?v=20260909-updates-ui-v10-45' in html
    assert '/static/js/pages/updates.js?v=20260909-updates-ui-v10-45' in html
    assert '/static/js/router.js?v=20260909-updates-ui-v10-45' in html
